...
export default memo(() => {
  ...
  const t = useI18n()
  const openHomePage = () => {
    void openUrl('https://github.com/app-pop/music-app#readme')
  }
  const openIssuePage = () => {
    void openUrl('https://github.com/app-pop/music-app/issues?q=is%3Aissue+')
  }
  const openGHReleasePage = () => {
    void openUrl('https://github.com/app-pop/music-app/releases')
  }
  const openFAQPage = () => {
  ...
  const openPartPage = () => {
    void openUrl('https://github.com/app-pop/music-app#%E9%A1%B9%E7%9B%AE%E5%8D%8F%E8%AE%AE')
  }
    ...
    <Section title={t('setting_about')}>
      <View style={styles.part}>
        ...
        <TouchableOpacity onPress={openHomePage}>
          <Text style={textLinkStyle}>https://github.com/app-pop/music-app</Text>
        </TouchableOpacity>
      </View>
      <View style={styles.part}>
